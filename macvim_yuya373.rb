...
class MacvimYuya373 < Formula
  ...
  conflicts_with 'macvim', :because => 'This Formula install macvim with my patches'
  ...
  def patches
    {
      :p1 => 'https://gist.githubusercontent.com/mattn/0c58a7398c63ab4c3066/raw'
    }
  end
